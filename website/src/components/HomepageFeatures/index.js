...
const FeatureList = [
  {
    ...
    description: (
      <>
        <Translate >With the book in hand, simply visit this site to view the shader samples immediately.</Translate>
      </>
    ),
  },
  {
    ...
    description: (
      <>
        <Translate >With WebGL 2.0, all samples can be viewed in various environments such as PCs, smartphones, and tablets.</Translate>
      </>
    ),
  },
  {
    ...
    description: (
      <>
        <Translate >Now, you can EDIT glsl samples in the codeblocks!</Translate>
      </>
    ),
  },
];
